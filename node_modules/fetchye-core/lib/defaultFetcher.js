...
exports.default = exports.defaultFetcher = exports.headersToObject = void 0;
...
const headersToObject = (headers = []) => [...headers].reduce((acc, [key, value]) => {
  acc[key] = value;
  return acc;
}, {});
...
const defaultFetcher = async (fetchClient, key, options) => {
  let res;
  let payload;
  let error;
